...
// static Lattice transfer(Lattice in, BasicBlock *bb)
// {
//     Lattice out;
...
//             {
//                 se = inst->getUses()[0]->getEntry();
//             }
//             else if (out.op2arraddr.count(inst->getUses()[0]))
//             {
//                 se = out.op2arraddr[inst->getUses()[0]].first;
//                 offset = out.op2arraddr[inst->getUses()[0]].second;
//             }
//             if (se != nullptr)
//             {
...
//                     {
//                         out.op2arraddr[inst->getDef()] = std::pair<IdentifierSymbolEntry *, int>{se, -1};
//                         se = nullptr;
//                         break;
//                     }
...
//             if (se != nullptr)
//             {
//                 out.arraddr2op[std::pair<IdentifierSymbolEntry *, int>{se, offset}] = inst->getDef();
//                 out.op2arraddr[inst->getDef()] = std::pair<IdentifierSymbolEntry *, int>{se, offset};
//             }
//             break;
//         }
...
//                 // if (out.arr2ops.count(dynamic_cast < inst->getUses()[0]->getEntry()))
...
//                 {
//                     for (int i = 0; i < out.arr2ops[out.op2arraddr[inst->getUses()[0]].first].size(); i++)
//                     {
//                         out.arr2ops[out.op2arraddr[inst->getUses()[0]].first][i] = nullptr;
//                     }
//                 }
//                 else
//                 {
//                     out.arr2ops[out.op2arraddr[inst->getUses()[0]].first][out.op2arraddr[inst->getUses()[0]].second] = inst->getUses()[1];
//                 }
//             }
//             else
//             {
...
//         std::map<IdentifierSymbolEntry *, Operand *> cur_changed_scalar;
//         std::map<IdentifierSymbolEntry *, std::vector<Operand *>> cur_changed_arr;
...
//             }
//             Lattice out = transfer(in, cur_bb);
...
//         if (cur_changed_arr != changed_arr[func] || cur_changed_scalar != changed_scalar[func])
//         {
//             changed = true;
